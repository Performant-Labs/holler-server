...
Local-machine plumbing that never touches the Holler circuit — listed here so "every protocol Holler uses" is actually complete, not just the network-facing ones.
